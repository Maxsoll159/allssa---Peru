...
router.post(async (req, res)=>{
    ...
    try {
        ...
        const order = await _server_modules_shared_db__WEBPACK_IMPORTED_MODULE_2__/* .prisma.informationOrder.update */ ._.informationOrder.update({
            data: req.body,
            where: {
                id
            }
...
router.get(async (req, res)=>{
    ...
    try {
        ...
        const order = await _server_modules_shared_db__WEBPACK_IMPORTED_MODULE_2__/* .prisma.informationOrder.findFirst */ ._.informationOrder.findFirst({
            where: {
                id,
                userId: userId
            }
